...
GUI can also run motion detection if it is in the same directory and motion detection program is named "Motion detection.exe"

See user manual for more information

Created By Jack and Larry